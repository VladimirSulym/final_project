            ...
            <div className="w-size14 p-t-30 respon5">
                <h4 className="product-detail-name m-text16 p-b-13">
                    ...
                    <form method="POST" action="">
                        ...
                        <input type="submit" name="submitAdd" /><br/>
                    </form>
                </h4>
                ...
                <div className="p-t-33 p-b-60">
                    ...
                    <div className="flex-m flex-w">
                        <div className="s-text15 w-size15_1 t-center">
                            Производитель
                        </div>

                        <div className="rs2-select2 rs3-select2 bo4 of-hidden w-size16_1">
                ...
                <div className="p-b-45">
                    ...
                    <span className="s-text8 m-r-35">ID продукта: 123123</span>
                    <span className="s-text8">Категория: lashdkajshkdas</span>
                </div>
